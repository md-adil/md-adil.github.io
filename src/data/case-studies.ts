...
export const caseStudies: CaseStudy[] = [
  {
    ...
    results: ["Response time: 800ms → 40-60ms (85% faster)", "5× more concurrent requests", "Cut infrastructure costs by 30-40%"],
  ...
  },
  {
    ...
    results: ["Services fail independently - one crash doesn't take down everything", "Teams own their services end-to-end", "Each service scales its database independently"],
  ...
  },
  {
    ...
    solution: "Built observability stack with distributed tracing, centralized logs, and real-time metrics using Grafana and ELK.",
  ...
  },
  {
    ...
    challenge: "Managing 600+ microservices with Helm + Azure Pipelines was chaos. No deployment history, manual rollbacks, zero visibility.",
    solution: "Implemented ArgoCD GitOps - Git as source of truth. Built Azure DevOps integration, auto-sync, self-healing, and SSO-based RBAC.",
    results: ["Deployment history saved in Git forever", "Auto-healing prevents config drift", "Full visibility in ArgoCD UI - no more kubectl/Lens"],
  ...
  },
  {
    ...
    solution: "Built design system with React and Storybook. Unified design tokens, reusable hooks, accessibility-first components.",
