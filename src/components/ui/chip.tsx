  ...
  "inline-flex items-center text-sm font-medium transition-colors",
  {
    variants: {
      variant: {
        ...
        primary: "px-4 py-2 bg-blue-50 text-blue-700 border border-blue-100 hover:border-blue-200 hover:bg-blue-100",
...
function Chip({ className, variant, ...props }: ChipProps) {
  return (
    <div className={twMerge(chipVariants({ variant }), className)} {...props} />
  )
}
