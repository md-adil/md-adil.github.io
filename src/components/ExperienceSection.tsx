...
const experiences = [
  {
    ...
    description: "Leading architecture and engineering for India's fastest-growing health-tech platform",
    responsibilities: [
  ...
  },
  {
    ...
    description: "Leading India's e-commerce solutions company for online sellers",
    responsibilities: [
      "Strategic Planning",
      "Team Management",
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            8+ years of building scalable solutions, leading teams, and creating impact in the tech industry
          </p>
        </div>
          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              <div key={index} className="relative animate-fade-in" style={{animationDelay: `${index * 0.2}s`}}>
                {/* Timeline dot */}
                <div className={`absolute left-6 w-4 h-4 rounded-full border-4 border-background shadow-lg hidden md:block animate-pulse-glow ${
                  exp.type === 'current' ? 'bg-primary' : 'bg-secondary'
                }`} style={{animationDelay: `${index * 0.3}s`}}>
                </div>

                <Card className={`ml-0 md:ml-16 glass-effect transition-all duration-500 hover-scale hover-glow group ${
                  exp.type === 'current' 
            ...
            {education.map((edu, index) => (
              ...
              >
                <CardHeader>
                  ...
                  <CardTitle className={`text-xl font-bold ${edu.type === 'ongoing' ? 'text-primary' : 'text-secondary'}`}>
                    {edu.degree}
                  </CardTitle>
                  <div className="flex items-center gap-2 text-muted-foreground">
