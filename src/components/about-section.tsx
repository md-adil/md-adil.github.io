        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-lg text-slate-700 leading-relaxed">
              I believe that software architecture is not just about choosing the right tools, but about understanding the trade-offs between consistency, availability, and
