...
const philosophy = [
  ...
  },
  {
    ...
    description:
      "Self-taught excellence through dedication and continuous learning",
    icon: Award,
  },
  {
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            A passionate developer's journey through technology, innovation, and
            continuous learning
          </p>
        </div>
        ...
        {/* Philosophy Cards */}
        <div className="mb-20">
          <h3 className="text-2xl font-bold text-center mb-8 text-shimmer">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          {skillCategories.map((category, index) => (
            ...
            >
              <CardHeader>
                <CardTitle
                  className={`text-2xl font-bold ${category.color} flex items-center`}
                >
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {achievements.map((achievement, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-primary to-secondary flex items-center justify-center group-hover:animate-pulse-glow`}
                >
              ...
              >
                <CardHeader>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge
                      variant="outline"
                      className="text-xs border-accent/30 hover:border-accent"
                    >
                      {project.type}
                    </Badge>
                  </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-muted-foreground">
                  Self-taught since 2009 - "School of Internet" graduate
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div
                ...
                ></div>
                <span className="text-muted-foreground">
                  Philanthropist, Tech Junkie, and Gymnast
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div
                ...
                ></div>
                <span className="text-muted-foreground">
                  Built songspk-dl CLI tool entirely in PHP
                </span>
              </div>
            </div>
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                ></div>
                <span className="text-muted-foreground">
                  Created YACS during lockdown to help people connect
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div
                ...
                ></div>
                <span className="text-muted-foreground">
                  TypeScript advocate - "thinks TypeScript first"
                </span>
              </div>
            </div>
          </div>
